...
This is the repository that hosts the code documentation for the MBTAriderSegmentation Python package with instructions on how to use the web-based visualization dashboard. For more details, please visit our Github [organization](https://github.com/AC297r-MBTA-2018/).
